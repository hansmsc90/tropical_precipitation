...
##pattern of files
glob_pattern_var = 'atm_2d_ml_202'
## Define the paths
...
outfile = '/scratch/m/m300876/data/dpp0066/interp/precip/res_01/dpp0066_daily_30S_30N_pr_'
########

save_files = interp3d.get_data_2d(files,var,0.1,0.1,grid_file,outfile,xini=-180., yini=-30., xend=180., yend=30., weights=None, better_times=True, resample_time = True, temporal_mean='1D')
